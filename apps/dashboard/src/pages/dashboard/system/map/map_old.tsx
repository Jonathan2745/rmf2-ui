...
import { DropPointPanel } from './components/old/ui/drop-point-panel';
import { RobotStatusPanel } from './components/old/ui/robot-status-panel';
...
import type {
  ...
  SceneViewerApi,
  StaticCollisionBox,
} from './components/old/robot-types';
...
import {
  ...
  SCENE_URL,
} from './components/old/constants';

// API
import { mergeRobotConfigs } from './components/old/robot-map-config/robot-config-merge';
import { useMapClient, MAP_API_KEY, MapClientError } from '@/clients/map';
import { toaster } from '@/components/ui/toaster';

// Robot helpers
import { getActiveRobotTarget } from './components/old/robot-map-coordinates/waypoint-utils';
import { stepDirectlyTowardWaypoint } from './components/old/robot-map-motion/direct-waypoint-motion';
import {
  modelHeadingToMovementHeading,
  movementHeadingToModelHeading,
} from './components/old/robot-map-motion/robot-heading';
import { toRobotStatus } from './components/old/robot-map-runtime/robot-status';
import { tuneMaterials } from './components/old/robot-map-runtime/robot-runtime-utils';
import {
  removeRobot,
...
import {
  computeSceneBounds,
  toSceneDebugInfo,
} from './components/old/robot-map-scene/scene-bounds';
import {
  animateIntroCamera,
  computeCameraFrame,
  frameCamera,
} from './components/old/robot-map-scene/scene-camera';
import {
  collectStaticCollisionBoxes,
  findRobotCollision,
} from './components/old/robot-map-scene/scene-collision';
import { disposeObject3D } from './components/old/robot-map-scene/scene-dispose';
import { createGridAxesHelpers } from './components/old/robot-map-scene/scene-grid-axis';
...
} from './components/old/scene-viewer';
